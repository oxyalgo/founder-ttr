      ...
      <section className="section bg-[var(--navy-dark)] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 mb-12">
            {RESULTS.map((r) => (
              <SpotlightCard key={r.label} className="rounded-xl" spotlightColor={`${r.color}20`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-10">
            {PROOF_IMAGES.map((proof, i) => (
              <ScrollReveal key={i} delay={i * 100}>
                <SpotlightCard className="rounded-xl" spotlightColor="rgba(212, 168, 67, 0.10)">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {PAYOUTS.map((payout, i) => (
              <ScrollReveal key={i} delay={i * 80}>
                <SpotlightCard className="rounded-xl" spotlightColor="rgba(212, 168, 67, 0.08)">
