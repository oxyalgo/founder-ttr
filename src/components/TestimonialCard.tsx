...
export default function TestimonialCard({
  ...
  return (
    <SpotlightCard
      ...
      spotlightColor="rgba(212, 168, 67, 0.10)"
    >
      <div className="glass rounded-2xl p-7 flex flex-col group hover:border-[var(--gold)]/20 transition-all duration-500">
        ...
        <div className="mb-4 relative">
          ...
          <div className="absolute -top-2 -left-1 text-[var(--gold)]/[0.06] text-7xl font-serif leading-none pointer-events-none select-none">
            &ldquo;
          </div>
        </div>
          ...
          {Array.from({ length: 5 }).map((_, i) => (
            <svg
              ...
              className={`w-5 h-5 transition-colors duration-300 ${
                i < rating ? 'text-[var(--gold)] drop-shadow-[0_0_4px_rgba(212,168,67,0.4)]' : 'text-[var(--card-border)]'
              }`}
              fill="currentColor"
              viewBox="0 0 20 20"
            >
